...
| openbas.extra-trusted-certs-dir   | OPENBAS_EXTRA-TRUSTED-CERTS-DIR | /opt/openbas/my_certs   | If you want to set extra trusted self-signed TLS certificates to communicate with external applications (Crowdstrike, Tanium,...), fill this attribute with you local folder containing your public .PEM certs. If you install OpenBAS with Docker, uncomment the volume and set the attribute in https://github.com/OpenBAS-Platform/docker/blob/master/docker-compose.yml | 

...
The OpenBAS platform manages 4 executors which can be installed on Windows, Linux and MacOS OS using x86_64 or arm64 architectures. This table below summarizes the information about each agent.
